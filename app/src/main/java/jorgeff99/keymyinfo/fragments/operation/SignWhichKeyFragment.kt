...
class SignWhichKeyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.fragment_sign_which_key, container, false)
        ...
        val chipGroup: ChipGroup = root.findViewById(R.id.chipGroupWhichSign)
